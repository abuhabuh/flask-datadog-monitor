...
resource "datadog_monitor" "AUTOGEN_integration_test_service_GET-base_test_all_monitors_APM_ERROR_RATE_ANOMALY" {
  name               = "AUTOGEN_integration_test_service_GET-base_test_all_monitors_APM_ERROR_RATE_ANOMALY"
  type               = "query alert"
  message            = ""
  escalation_message = ""
